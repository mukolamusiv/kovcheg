...
class Transaction extends Model
{
    ...
    public static function customer_pay_transaction(array $data, Customer $customer, Invoice $invoice)
    {



        //треба ще додати перевірку і заповнення даних у накладній




        //dd($data, $customer,$invoice);
       ...
       // $suppliner = new Supplier();

        //$account = new Account(); // гаманнець на який нараховуються гроші
        ...
        $entry2->account_id = $customer->account->id; // ID рахунку клієнта для кредиту
