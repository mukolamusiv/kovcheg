    ...
    protected static function booted()
    {
        ...
        static::updating(function($productionMaterial){
            if($productionMaterial->material->checkMaterialInWarehouse($productionMaterial->warehouse_id)){
               ...
               $warehouseFirst = $warehouse->first();//->warehouseMaterial($productionMaterial->material->id);
               $productionMaterial->price = $warehouseFirst->price;
               // dd($data, $warehouse, $productionMaterial->material->getPricesMaterial($productionMaterial->warehouse_id), $productionMaterial->material, $productionMaterial);
            }
        });
    }
}
