    ...
    protected static function booted()
    {
        ...
        static::updating(function($productionMaterial){
            if($productionMaterial->material->checkMaterialInWarehouse($productionMaterial->warehouse_id)){
              ...
              // $data = $warehouse->warehouseMaterial($productionMaterial->material->id);
                dd( $warehouse, $productionMaterial->material->getPricesMaterial($productionMaterial->warehouse_id), $productionMaterial->material, $productionMaterial);
            }
        });
    }
}
